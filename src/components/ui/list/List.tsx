        ...
        {items.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="prose prose-invert flex flex-col items-start justify-start leading-[1.2] text-foreground/80 prose-h1:mb-0 prose-img:rounded-xl [&>*]:text-foreground"
